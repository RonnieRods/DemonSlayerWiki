...
type.addEventListener('click', () => {
    curImg.src = "/../DemonSlayerWiki/images/Gyomei_anime_right_face.webp";
    curImg.title = `Gyomei's anime appearance`
...
secType.addEventListener('click', () => {
    curImg.src = "/../DemonSlayerWiki/images/Gyomei_colored_body.webp";
    curImg.title = `Gyomei's manga appearance`
