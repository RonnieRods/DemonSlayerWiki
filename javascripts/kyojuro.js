...
type.addEventListener('click', () => {
    curImg.src = "/../DemonSlayerWiki/images/Kyojuro_anime_right_face.webp";
    curImg.title = `Kyojuro's anime appearance`
...
secType.addEventListener('click', () => {
    curImg.src = "/../DemonSlayerWiki/images/Kyojuro_colored_body.webp";
    curImg.title = `Kyojuro's manga appearance`
